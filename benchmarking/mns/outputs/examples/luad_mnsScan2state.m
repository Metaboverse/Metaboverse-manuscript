...
%% load the model in this case KEGG_SCE_MNS
load KEGG_HSA_MNS
model = KEGG_HSA_MNS;

%% load the data
T=readtable('examples\lung_tumor_vs_normal_measurements.txt');
data = struct();
data.id=T{:,1};
data.fc_log2=T{:,2};
%% generate data structure

nameTag = 'TumorVsNormal';
