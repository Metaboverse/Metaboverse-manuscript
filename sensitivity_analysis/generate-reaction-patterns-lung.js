...
for (let f in lung_file_list) {
    ...
    let filename_motifs_collapsed_avg = lung_file_list[f].slice(0, -5) + "_avg_collapse.csv";
    let filename_motifs_collapsed_modreg = lung_file_list[f].slice(0, -5) + "_mod_collapse.csv";
    ...
    let filename_motifs_avg = lung_file_list[f].slice(0, -5) + "_avg_noCollapse.csv";
    let filename_motifs_modreg = lung_file_list[f].slice(0, -5) + "_mod_noCollapse.csv";
